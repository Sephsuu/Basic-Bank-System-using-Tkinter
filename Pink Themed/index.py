...
def main_window():
    ...
    pin_in.pack(pady=(330, 0), anchor="n")
    pin_in.configure(bg="#f4c2c2")
    tk.Frame(root, width=270, height=2, bg="black").place(x=545, y=200)
    pin_in.insert(0, "Enter your PIN number")
    pin_in.bind("<FocusIn>", enter)
    pin_in.bind("<FocusOut>", leave)

    button = tk.Button(root, text="Enter", fg="white", bg="#cd5e77", font=b, width=15, command=isValid)
    button.pack(pady=20)
...
def bank_window(account):
    ...
    header2 = tk.Label(bank, text=f"{account.account_name}", fg=brownish, font=h1, bg=pink)
    ...
    header3 = tk.Label(bank, text=f"Account No. {account.account_number}", font=b, bg=pink, fg=brownish)
...
def checking(bank, account):
    ...
    deposit_button.pack(pady=(130, 0), anchor="n")
...
def deposit_checking(check, account):
    ...
    header2 = tk.Label(deposit, text=f"Balance: ₱{account.get_balance()}", bg=pink, fg=brownish, font=p)
    header2.pack(pady=(100, 0), anchor="n")
...
def withdraw_checking(check, account):
    ...
    header2 = tk.Label(withdraw, text=f"Balance: ₱{account.get_balance()}", bg=pink, fg=brownish, font=p)
    header2.pack(pady=(100, 0), anchor="n")
...
def deposit_savings(check, account):
    ...
    header2 = tk.Label(deposit, text=f"Balance: ₱{sAccount.get_balance()}", bg=pink, fg=brownish, font=p)
    header2.pack(pady=(100, 0), anchor="n")
...
def withdraw_savings(check, account):
    ...
    header2 = tk.Label(withdraw, text=f"Balance: ₱{sAccount.get_balance()}", bg=pink, fg=brownish, font=p)
    header2.pack(pady=(100, 0), anchor="n")
